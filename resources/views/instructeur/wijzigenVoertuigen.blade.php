        ...
        <form method="post" action="{{route('instructeur.bijwerken', ['instructeur' => $instructeurs->id, 'voertuig' => $voertuig->id])}}">
            ...
            <div class="formField">
                ...
                <select name="instructeur" id="instructeur">
                    ...
                    <!-- Used to auto-select the selected instructor and show all non-selected instructors -->
            ...
            <div class="formField">
                ...
                <select name="typeVoertuig" id="typeVoertuig">
                    ...
                    <!-- Used to auto-select voertuig type and show all non-selected voertuig types -->
            ...
            <div class="formField" id="brandstof">
                <!-- Brandstof -->
